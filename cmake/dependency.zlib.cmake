...
ExternalProject_Add(ZLIB
    ...
    INSTALL_BYPRODUCTS "<INSTALL_DIR>/lib/$<IF:$<AND:$<BOOL:${WIN32}>,$<CONFIG:Debug>>,${ZLIB_LIBRARY_NAME_DEBUG},${ZLIB_LIBRARY_NAME}>"
...
target_link_libraries(LibZLIB INTERFACE
    "${ZLIB_ROOT}/lib/$<IF:$<AND:$<BOOL:${WIN32}>,$<CONFIG:Debug>>,${ZLIB_LIBRARY_NAME_DEBUG},${ZLIB_LIBRARY_NAME}>"
)
